...
function cAc() {
    characters.push("Mirizé Vladilena", "Akame", "Leone", "Mine", "Chelsea", "Esdeath", "Tachibana Kanade", "Nakamura Yuri", "Kayano Kaede", "Angel Melida", "Hanekawa Tsubasa", "Sengoku Nadeko", "Senjougahara Hitagi", "Araragi Karen", "Araragi Tsukihi", "Hachikuji Mayoi", "Kanbaru Suruga", "Kiss-Shot Acelora-Orion Heart-Under-Blade", "Oshino Shinobu", "Araragi Tsukihi", "Kagenui Yozuru", "Ononoki Yotsugi", "Oikura Sodachi", "Gaen Izuko", "Oshino Ougi", "Hinata Kaho", "Hoshikawa Mafuyu", "Sakuranomiya Maika", "Kanzaki Hideri", "Kousaka Akiho", "Ariyama Shizuku", "Kurobane Yusa", "Otosaka Ayumi", "Tomori Nao", "Kurobane Misa", "Yin (dtb)", "Pavlichenko Suou", "Ichigo ", "Kokoro Darling in the FranXX", "Miku Darling in the FranXX", "Zero Two", "Karino Shuka", "Tachibana Hina", "Tachibana Rui", "Kohaku (dr kamien)", "Hestia (danmachi)", "Freya (danmachi)", "Hephaistos (danmachi)", "Yamato Mikoto (danmachi)", "Wallenstein Aiz (danmachi)", "Lion Ryu (danmachi)", "Artemis (danmachi)", "Ganesha xd (danmachi)", "Sanjouno Haruhime (danmachi)", "Izumi Sagiri", "Co Lada Piña", "Mercury Rory", "Marceau Tuka Luna", "Evergarden Violet", "Baudelaire Cattleya", "Aoki Claire", "Shinkan Onna", "Yunde Yousei", "Kaga Kouko", "Hayashida Nana", "Nakano Ichika", "Nakano Itsuki", "Nakano Nino", "Nakano Miku", "Nakano Yotsuba", "Uesugi Raiha", "Kotegawa Chisa", "Hamaoka Azusa", "Yoshiwara Aina", "Kotegawa Nanaka", "Ogiwara Sayu", "Hori Kyouko", "Nagatoro Hayase", "Yoshi (nagataro)", "Gamou Maki (nagataro)", "Sakur (nagataro)", "Fujiwara Chika", "Shinomiya Kaguya", "Hayasaka Ai", "Shirogane Kei", "Jabami Yumeko", "Saotome Meari", "Yomozuki Runa", "Momobami Kirari", "Yumemite Yumemi", "Hina (Kamisama ni Natta Hi)", "Saki Saki (Kanojo mo Kanojo)", "Hoshizaki Rika (Kanojo mo Kanojo)", "Kiryuu Shino (Kanojo mo Kanojo)", "Minase Nagisa (Kanojo mo Kanojo)", "Mizuhara Chizuru", "Kamado Nezuko", "Kobayashi (Kobayashi-san Chi no Maid Dragon)", "Tooru (Kobayashi-san Chi no Maid Dragon)", "Kamui Kanna (Kobayashi-san Chi no Maid Dragon)", "Elma (Kobayashi-san Chi no Maid Dragon)", "Quetzalcoatl (Kobayashi-san Chi no Maid Dragon)", "Nishimiya Shouko", "Komi Shouko", "Osana Najimi", "Makeru Yadano", "Yamai Ren", "Darkness (Kono Suba)", "Aqua (Kono Suba)", "Megumin (Kono Suba)", "Eris (Kono Suba)", "Wiz (Kono Suba)", "Yunyun (Kono Suba)", "Flan (Majo no Tabitabi)", "Elaina (Majo no Tabitabi)", "Sheila (Majo no Tabitabi)", "Gasai Yuno", "Kurousagi (Mondaiji-tachi ga Isekai kara Kuru Sou Desu yo?)", "Kudou Asuka (Mondaiji-tachi ga Isekai kara Kuru Sou Desu yo?)", "Kasukabe You (Mondaiji-tachi ga Isekai kara Kuru Sou Desu yo?)", "Sylphiette", "Migurdia Roxy", "Boreas Greyrat Eris", "Greyrat Lilia", "Greyrat Zenith", "Migurdia Roxy", "Onodera Kosaki", "Kirisaki Chitoge", "Tachibana Marika", "Tsugumi Seishirou", "Shiro (ngnl)", "Dola Stephanie (ngnl)", "Jibril (ngnl)", "Miko (ngnl)", "Hatsuse Izuna (ngnl)", "Tatsumaki", "Fubuki", "Holo", "Akino Sakura", "Hinata Aoi", "Sanshokuin Sumireko", "Albedo", "Bello Fiore Mare", "Bella Fiora Aura", "Alpha Yuri", "Beta Lupusregina", "Bloodfallen Shalltear", "Shizu Delta", "Isla (Plastic Memories)", "Rem", "Ram", "Emilia", "Beatrice", "Felt", "Argyle Felix ", "Ferris", "Baumann Frederica", "Echidna", "Aoyama Nanami", "Kamiigusa Misaki", "Shiina Mashiro", "Sengoku Chihiro", "Sakurajima Mai", "Azusagawa Kaede", "Futaba Rio", "Kamisato Saki", "Makinohara Shouko", "Toyohama Nodoka", "Koga Tomoe", "Dia (Sekai Saikou no Ansatsusha Isekai Kizoku ni Tensei Suru)", "Maha (Sekai Saikou no Ansatsusha Isekai Kizoku ni Tensei Suru)", "Tarte (Sekai Saikou no Ansatsusha Isekai Kizoku ni Tensei Suru)", "Esri (Sekai Saikou no Ansatsusha Isekai Kizoku ni Tensei Suru)", "Kisaragi Alice (Sentouin Hakenshimasu!)", "Astaroth (Sentouin Hakenshimasu!)", "Belial (Sentouin Hakenshimasu!)", "Grimm (Sentouin Hakenshimasu!)", "Heine (Sentouin Hakenshimasu!)", "Rose (Sentouin Hakenshimasu!)", "Lilith (Sentouin Hakenshimasu!)", "Snow (Sentouin Hakenshimasu!)", "Grace Tillis (Sentouin Hakenshimasu!)", "Senko (Sewayaki Kitsune no Senko-san)", "Shiro (Sewayaki Kitsune no Senko-san)", "Sora (Sewayaki Kitsune no Senko-san)", "Miyazono Kaori", "Sawabe Tsubaki", "Ackermann Mikasa", "Blouse Sasha", "Reiss Historia", "Zoë Hange", "Leonhart Annie", "Dreyse Hitch", "Yuuki Asuna", "Alicia Rue", "Shinozaki Rika", "Ayano Keiko", "Konno Yuuki", "Asada Shino", "Shigemura Yuuna", "Kirigaya Suguha", "Unmei (takt op.Destiny)", "Titan (takt op.Destiny)", "Shneider Anna", "Filo (Tate no Yuusha no Nariagari)", "Raphtalia (Tate no Yuusha no Nariagari)", "Kirishima Touka", "Kamishiro Rize", "Yuzaki Tsukasa (Tonikaku Kawaii)", "Arisugawa Aya (Tonikaku Kawaii)", "Aurora (Tonikaku Kawaii)", "Charlotte (Tonikaku Kawaii)", "Arisugawa Kaname (Tonikaku Kawaii)", "Kaginoji Chitose (Tonikaku Kawaii)", "Aisaka Taiga", "Kawashima Ami", "Kushieda Minori", "Vivy", "Yuigahama Yui", "Yukinoshita Yukin", "Hiratsuka Shizuka", "Horikita Suzune", "Kushida Kikyou", "Chabashira Sae", "Ichinose Honami", "Sakura Airi", "Sakayanagi Arisu", "Yue", "Haulia Shea", "Klarus Tio", "Shirasaki Kaori", "Yaegashi Shizuku", "Myu", "Ayukawa Ryuji", "Ichijou Aoi", "Kanzaki Keine", "Mikogami Tsukasa", "Oohoshi Ringo", "Prince Akatsuki", "Sarutobi Shinobu", "Dekomori Sanae", "Nibutani Shinka", "Takanashi Rikka", "Tsuyuri Kumin", "Honda Tooru", "Akiyama Yukari", "Isuzu Hana", "Nishizumi Miho", "Reizei Mako", "Katyusha", "Takebe Saori", "Argento Asia", "Gremory Rias", "Himejima Akeno", "Quarta Xenovia", "Toujou Koneko", "Vladi Gasper", "Akiyama Mio", "Hirasawa Yui", "Kotobuki Tsumugi", "Nakano Azusa", "Tainaka Ritsu", "Hirasawa Ui", "Yamanaka Sawako", "Yotsuya Miko", "Yurikawa Hana", "Bishamon", "Iki Hiyori", "Ebisu Kofuku", "Gardner Rachel", "Ward Catherine", "Kuga Asahi", "Usui Satsuki", "Ristarte (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Ariadoa (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Hestiaca (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Mitis (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Valkyrie (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Roseguard Rosalie (Shinchou Yuusha: Kono Yuusha ga Ore TUEEE Kuse ni Shinchou Sugiru)", "Kitagawa Marin", "Bristol Lilith", "Hotaka Miyabi", "Sigtuna Julie", "Hoshino Lily", "Tachibana Tomoe", "Ochako Uraraka", "Yuu Takeyama (Mt. Lady)", "Hatsume Mei", "Himekawa Yoshino", "Itsuka Kotori", "Tobiichi Origami", "Yatogami Tooka", "Tokisaki Kurumi", "Ririko", "Alexia van Riessfeld Julis", "Enfield Claudia", "Sasamiya Saya", "Toudou Kirin", "Irisu Makina", "Komine Sachi", "Matsushima Michiru", "Sakaki Yumiko", "Suou Amane", "Crossfode Emile", "Harvey Claire", "Kirishima Sakura", "Kisaragi Karen", "Alcott Cecilia", "Bodewig Laura", "Dunois Charlotte", "Huang Lingyin", "Shinonono Houki", "Freyja Iris", "Mononobe Mitsuki", "Crest Firill", "Lightning Tear", "Highwalker Lisa", "Neko (K)", "Brunestud Arcueid", "Pendragon Artoria", "Toono Akiha", "Toosaka Rin", "Ciel", "Medea", "Medusa", "Aozaki Touko", "Augustus Germanicus Nero Claudius Caesar", "Fraga McRemitz Bazett", "Fujimura Taiga", "Hortensia Caren", "Kokutou Azaka", "Kuzuki Souichirou", "von Einzbern Illyasviel", "von Einzbern Irisviel", "Yumizuka Satsuki", "Edelfelt Luviagelita", "Edelfelt Miyu", "Sella", "Leysritt", "Gray", "El-Melloi Archisorte Reines", "Lehrman Yvette L.", "d'Arc Jeanne", "Pendragon Mordred", "Ryougi Shiki", "Kyrielight Mash", "Fujimaru Ritsuka", "da Vinci Leonardo", "Quetzalcoatl", "Ushiwakamaru", "Asmleit Animusphere Olga Marie", "Ereshkigal", "von Einzbern Chloe", "Astolfo", "Frankenstein", "Bladefield Nanami Knight", "Mahougasawa Akane", "Shoukanji Kikuno", "Takagi", "Kiryuu Mizuha", "Koga Yuika", "Nanjou Mao", "Tokihara Sayuki", "Kannagi Ayano", "Eisenbach Lecty", "Flamel Rico", "Whitale Misora", "Iwanaga Kotoko", "Shizuka Hanekura Akatsuki", "Shiba Miyuki", "Necron Sasha", "Necron Misha", "Akishino Himeka", "Fuyuumi Ai", "Harusaki Chiwa", "Natsukawa Masuzu", "Kachi Shirokusa", "Maria Momosaka", "Shida Kuroha", "Kurogane Shizuku", "Vermillion Stella", "Fibel Sistine", "Tingel Rumia", "Arfonia Celica", "Aingram Philphie", "Atismata Lisesharte", "Einfolk Krulcifer", "Kirihime Yoruka", "Ralgris Celistia", "Aishia (Seirei Gensouki)", "Latifa (Seirei Gensouki)", "Claire Celia (Seirei Gensouki)", "Fahrengart Ellis", "Est Terminus", "Ray Ordesia Fianna", "Laurenfrost Rinslet", "Rouge Claire", "Ashdoll Restia", "Naruse Maria", "Naruse Mio", "Nonaka Yuki", "Kanoe Kirie", "Kanoe Yuuko", "Asami Lilith", "Fudou Akio", "Kannazuki Arin", "Kazama Levi", "Kurata Yui", "Sherlock Lieselotte", "Yamana Mira", "Uzaki Hana", "Gakesaka Minori", "Misenai Kanan", "Toyofusa Urara", "Yasuraoka Hanabi", "Miyauchi Renge", "Koshigaya Natsumi", "Koshigaya Komari", "Ichijou Hotaru", "Halkara (Slime Taoshite 300-nen Shiranai Uchi ni Level Max ni Nattemashita)", "Falfa (Slime Taoshite 300-nen Shiranai Uchi ni Level Max ni Nattemashita)", "Laika (Slime Taoshite 300-nen Shiranai Uchi ni Level Max ni Nattemashita)", "Shalsha (Slime Taoshite 300-nen Shiranai Uchi ni Level Max ni Nattemashita)", "Aizawa Azusa (Slime Taoshite 300-nen Shiranai Uchi ni Level Max ni Nattemashita)", "Victoria Seras", "Van Winkle Rip", "Busujima Saeko", "Maresato Alice", "Marikawa Shizuka", "Miyamoto Rei", "Takagi Saya", "von Claude Sicily", "Azazel Ameri", "Valac Clara", "Maou (Maoyuu Maou Yuusha)", "Hiiragi Nana", "Habu Kirara", "Dola Corone", "Dola Shuvi", "Claes Catarina", "Ascart Radia", "Ascart Sophia", "Campbell Maria", "Hunt Mary", "Hiiragi Shinoa", "Siesta", "Tomoe (Tsuki ga Michibiku Isekai Douchuu)", "Mio (Tsuki ga Michibiku Isekai Douchuu)", "Ralei Ninym (Tensai Ouji no Akaji Kokka Saisei Jutsu)", "Tachibana Hinata");
    console.log(characters);
}
//characters log
function cI() {
...
function random() {
    ...
    //Age rating section functioning + math
    if (e==true) {
    ...
    //ammount of rolls gonna shit on this one fuck me pls help
    //actually shouldnt this be the last thing i do?
    //for (let r=document.getElementById('r').valueAsNumber; r>=1;) {
        r=r-1;
        console.log(r);
...
//implement later in random() for SITE OPTIMIZATION after output
//actually also fixes some bugs
//participants.splice(0,participants.length);
//characters.splice(0,characters.length);
//arating.splice(0,arating.length);
//type.splice(0,type.length);
